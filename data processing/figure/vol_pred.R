...
plot(err.cur, main = "prediction model vs. actual data error",type = "h", xlab = "index of current data point", ylab = "error between model and test data (Amp)")
...
par(new = TRUE)
plot(dec.vol,type = "l", xlab = "index of voltage data point", ylab = "actual voltage data (Amp)",xlim = c(0,length(dec.vol)))
err.vol = 0
err.vol[1:5000] = 0.0;
